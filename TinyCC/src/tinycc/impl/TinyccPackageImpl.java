 ...
 * @generated
 */
public class TinyccPackageImpl extends EPackageImpl implements TinyccPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see tinycc.TinyccPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TinyccPackageImpl() {
		super(eNS_URI, TinyccFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link TinyccPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TinyccPackage init() {
		if (isInited) return (TinyccPackage)EPackage.Registry.INSTANCE.getEPackage(TinyccPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTinyccPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		TinyccPackageImpl theTinyccPackage = registeredTinyccPackage instanceof TinyccPackageImpl ? (TinyccPackageImpl)registeredTinyccPackage : new TinyccPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theTinyccPackage.createPackageContents();

		// Initialize created meta-data
		theTinyccPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTinyccPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TinyccPackage.eNS_URI, theTinyccPackage);
		return theTinyccPackage;
	}
	 ...
	 */
	@Override
	public EReference getConnectorEnd_Properties() {
	 ...
	 */
	@Override
	public EReference getConnector_OppositeConnector() {
	 ...
	 */
	@Override
	public EReference getItem_Connectors() {
	 ...
	 */
	@Override
	public TinyccFactory getTinyccFactory() {
		return (TinyccFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(connectorEndEClass, CONNECTOR_END__PROPERTIES);
	...
	public void initializePackageContents() {
		...
		initEReference(getPort_Properties(), this.getProperty(), null, "properties", null, 0, -1, Port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(connectorEndEClass, ConnectorEnd.class, "ConnectorEnd", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConnectorEnd_Properties(), this.getProperty(), null, "properties", null, 0, -1, ConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
