 ...
 *   <li>{@link tinycc.impl.PropertyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	protected EClass eStaticClass() {
		return TinyccPackage.Literals.PROPERTY;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinyccPackage.PROPERTY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TinyccPackage.PROPERTY__VALUE:
				return getValue();
			case TinyccPackage.PROPERTY__NAME:
				return getName();
		}
