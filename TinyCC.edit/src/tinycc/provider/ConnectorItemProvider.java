...
/**
 * This is the item provider adapter for a {@link tinycc.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider extends SimlementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOppositeConnectorPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Opposite Connector feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOppositeConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_oppositeConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_oppositeConnector_feature", "_UI_Connector_type"),
				 TinyccPackage.Literals.CONNECTOR__OPPOSITE_CONNECTOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TinyccPackage.Literals.CONNECTOR__ENDS,
				 TinyccFactory.eINSTANCE.createConnectorEnd()));
