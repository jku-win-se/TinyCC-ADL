...
/**
 * This is the item provider adapter for a {@link tinycc.ConnectorEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorEndItemProvider extends SimlementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectorEnd_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorEnd_port_feature", "_UI_ConnectorEnd_type"),
				 TinyccPackage.Literals.CONNECTOR_END__PORT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TinyccPackage.Literals.CONNECTOR_END__PROPERTIES);
		}
	...
	public String getText(Object object) {
		String label = ((ConnectorEnd)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TinyccPackage.Literals.CONNECTOR_END__PROPERTIES,
